...
CITY_US = {
    ...
    ("Fresno", "California"): (36.74, -119.79),
    ...
    ("Woodside", "California"): (37.43, -122.25),
    ...
    ("Idaho Falls", "Idaho"): (43.49, -112.03),
    ...
    ("Alexandria", "Virginia"): (38.80, -77.05),
...
REGION = {
    ...
    ("Idaho", "United States"): (44.35, -114.60),
    ...
    ("Mississippi", "United States"): (32.75, -89.65),
    ...
    ("Wisconsin", "United States"): (44.50, -89.50),
